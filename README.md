...
```py
//tests/trial.py
from __future__ import (abolute_import, division, 
...
if __name__ == '__main__':
  ...
  parse = argparse.ArgumentParser(
    description='Test the true positive and false positve rate.')
  ...
  results['fp'] = 0
  results['fn'] = 0
  nudepath = os.path.join('sample', 'nude')
  ...
  for notnudepic in os.listdir(notnudepath):
    fname = os.path.join(notnudepath, notnudpic)
    pool.apply_async(testfile, (fname, ), {
